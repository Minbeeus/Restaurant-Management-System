    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModifierRecipes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ModifierRecipes_ModifierOptions_ModifierOptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalCashOrders = table.Column<int>(type: "int", nullable: false),
                    TotalTransferOrders = table.Column<int>(type: "int", nullable: false),
                    TotalCashAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalTransferAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ConductedByUserId = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    Note = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stocktakes_Users_ConductedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecipeItems_UnitOfMeasures_UnitOfMeasureId",
                        column: x => x.UnitOfMeasureId,
                        principalTable: "UnitOfMeasures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ModifierRecipeId = table.Column<int>(type: "int", nullable: false),
                    MaterialId = table.Column<int>(type: "int", nullable: false),
                    UnitOfMeasureId = table.Column<int>(type: "int", nullable: false),
                    Quantity = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ModifierRecipeItems_Materials_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Materials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ModifierRecipeItems_ModifierRecipes_ModifierRecipeId",
                        column: x => x.ModifierRecipeId,
                        principalTable: "ModifierRecipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ModifierRecipeItems_UnitOfMeasures_UnitOfMeasureId",
                        column: x => x.UnitOfMeasureId,
                        principalTable: "UnitOfMeasures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GoodsReceiptItems_Materials_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Materials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GoodsReceiptItems_UnitOfMeasures_UnitOfMeasureId",
                        column: x => x.UnitOfMeasureId,
                        principalTable: "UnitOfMeasures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoyaltyDiscountAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StocktakeItems_Materials_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Materials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SepayContent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    CompletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_Shifts_ShiftId1",
                        column: x => x.ShiftId1,
                        principalTable: "Shifts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VoidByUserId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VoidLogs_MenuItems_MenuItemId",
                        column: x => x.MenuItemId,
                        principalTable: "MenuItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VoidLogs_OrderItems_OrderItemId",
                        column: x => x.OrderItemId,
                        principalTable: "OrderItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VoidLogs_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VoidLogs_Orders_OrderId1",
                        column: x => x.OrderId1,
                        principalTable: "Orders",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VoidLogs_Users_VoidByUserId",
                        column: x => x.VoidByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SepayWebhookLogs_Payments_PaymentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoodsReceiptItems_UnitOfMeasureId",
                table: "GoodsReceiptItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModifierRecipeItems_MaterialId",
                table: "ModifierRecipeItems",
                column: "MaterialId");

            migrationBuilder.CreateIndex(
                name: "IX_ModifierRecipeItems_ModifierRecipeId",
                table: "ModifierRecipeItems",
                column: "ModifierRecipeId");

            migrationBuilder.CreateIndex(
                name: "IX_ModifierRecipeItems_UnitOfMeasureId",
                table: "ModifierRecipeItems",
                column: "UnitOfMeasureId");

            migrationBuilder.CreateIndex(
                name: "IX_ModifierRecipes_ModifierOptionId",
                table: "ModifierRecipes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeItems_UnitOfMeasureId",
                table: "RecipeItems",
                column: "UnitOfMeasureId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SepayWebhookLogs_PaymentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StocktakeItems_MaterialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stocktakes_ConductedByUserId",
                table: "Stocktakes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VoidLogs_MenuItemId",
                table: "VoidLogs",
                column: "MenuItemId");

            migrationBuilder.CreateIndex(
                name: "IX_VoidLogs_OrderId",
                table: "VoidLogs",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_VoidLogs_OrderId1",
                table: "VoidLogs",
                column: "OrderId1");

            migrationBuilder.CreateIndex(
                name: "IX_VoidLogs_OrderItemId",
                table: "VoidLogs",
                column: "OrderItemId");

            migrationBuilder.CreateIndex(
                name: "IX_VoidLogs_VoidByUserId",
                table: "VoidLogs",
                column: "VoidByUserId");
        }
